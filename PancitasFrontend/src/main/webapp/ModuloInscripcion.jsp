...
<style>
  ...
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Documento-Nit:</label>
 ...
 <div class="col-6">
    <label for="inputAddress" class="form-label">Nombre Contacto(Fundacion/Restaurante):</label>
    <input type="text" class="form-control" id="inputAddress" name="contactoRestaurante">
  </div>
  <div class="col-md-6">
    <label for="inputCity" class="form-label">Email:</label>
    <input type="email" class="form-control" required="required" id="inputCity" name="emailRestaurante">
  </div>
  <div class="col-md-6">
    <label for="inputCity" class="form-label">Ciudad:</label>
    <input type="text" class="form-control" required="required" id="inputCity" name="ciudadRestaurate">
  </div>
  <div class="col-md-6">
    <label for="inputAddress" class="form-label">Dirección:</label>
    <input type="text" class="form-control" required="required" id="inputAddress" name="dirRestaurante">
  </div>
  
  <div class="col-md-6">
    <label for="inputCity" class="form-label">Teléfono Contacto:</label>
    <input type="number" class="form-control" required="required" id="inputCity" name="teflRestaurante">
  </div>
  <div class="col-md-6">
    <label for="inputCity" class="form-label">Placa(Vehiculo):</label>
    <input type="text" class="form-control"  id="inputCity" name="teflRestaurante">
  </div>
  ...
  <div class="col-6">
    ...
    <input type="text" class="form-control" required="required" id="inputAddress" name="infoadicional" placeholder="Informacion Adicional">
  </div>
